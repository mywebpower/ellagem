...
gulp.task('update-nodes', (cb) => {
    ...
    got('https://api.github.com/repos/ellaism/go-ellaism/releases/latest', { json: true })
    .then((response) => {
    ...
    .then((tagName) => {
        ...
        if (cmp(latestGethVersion, localGethVersion)) {
            ...
            got(`https://api.github.com/repos/ellaism/go-ellaism/commits/${tagName}`, { json: true })
            .then((response) => {
